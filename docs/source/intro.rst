...
- To **comprehensively** document the `LibreOffice <https://www.libreoffice.org/>`_ Basic programming language and the LibreOffice API **as it is used in Basic**.
...
.. note::
   ...
   **COPYRIGHT / LICENSE** 
   This work is licensed under the :doc:`Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International Public License <license/license>`. TL:DR Yes, you can use my stuff. No, you can't pretend it's your stuff. No, you can't make money off of stuff I made for free.
